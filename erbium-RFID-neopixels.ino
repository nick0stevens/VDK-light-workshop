/*
   --------------------------------------------------------------------------------------------------------------------
   BAsed onExample sketch/program showing An Arduino Door Access Control featuring RFID, EEPROM, Relay
   --------------------------------------------------------------------------------------------------------------------
...
byte card1[4] = {143,98,90,41};
byte card2[4] = {96,122,234,162};
;
...
void loop () {
  ...
  Serial.println();
    for ( uint8_t i = 0; i < 4; i++) {  //
    Serial.print(card1[i], DEC);
  }
       Serial.println(); 
   if(checkTwo ( readCard, card1 )){
                  Serial.println(F("Welcome, You shall pass card 1"));
 runCard1();
          }
        else if( checkTwo ( readCard, card2 )){
                  Serial.println(F("Welcome, You shall pass card 2"));
  runCard2();
          }
